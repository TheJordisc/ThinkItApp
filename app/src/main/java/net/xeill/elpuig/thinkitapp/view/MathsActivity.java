...
//        });
        ...
        if (settings.getBoolean("mute",true)) {
            ...
            mInitialCountdownTick.setVolume(0f,0f);
            mInitialCountdownEnd.setVolume(0f,0f);
        } else {
            ...
            mInitialCountdownTick.setVolume(0.7f,0.7f);
            mInitialCountdownEnd.setVolume(0.7f,0.7f);
        }
